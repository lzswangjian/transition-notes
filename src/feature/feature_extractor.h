...
public:
    ...
    // Initializes the feature function. N.B.: The FeatureType of this function must be
    // established when this method completes.
...
/*!
 * \brief Base class for a nested feature function takes nested features with
 * the same signature as these features, i.e. a meta feature. For this class, we
 * can provide preprocessing of the nested features.
 */
template<class OBJ, class ...ARGS>
