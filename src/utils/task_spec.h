...
public:
    ...
    const string &record_format() const {
        return record_format_;
    }
    void set_record_format(const string &format) { file_format_ = format; }
    ...
    struct Part {
        ...
        void set_file_pattern(const string &file_pattern) { file_pattern_ = file_pattern; }
